...
window = 256;
center_pos = [961, 1306]; %% position of center psf of center scanning position
right_pos = [950, 2046]; %% position of center psf of most right scanning position
down_pos = [1698, 1312]; %% position of center psf of most down scanning position
tmp_separation = 25;
...
right_pos2 = [975, 1898]; %% position of right psf of center scanning position
down_pos2 = [1561, 1300]; %% position of down psf of center scanning position
...
for i = 1:3
    for j=1:3
        ...
        imwrite(J,parula,['mla_R10S51_2/xcorr_map_',num2str(i),num2str(j),'.tif']);
    end
end
%% separation analysis
