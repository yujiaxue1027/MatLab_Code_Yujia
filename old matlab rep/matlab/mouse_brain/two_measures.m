%% script on testing two measurements recon
...
obj1(sqrt(x.^2+y.^2)>=150&sqrt(x.^2+y.^2)<=160) = 1;
obj1(246:266,216:296) = 1;
obj1(216:296,246:266) = 1;
imagesc(obj1),axis image off;
load('simu_psf.mat');
y1 = conv2d(obj1,psf);
figure,imagesc(y1),axis image off;truesize;
para= [];
