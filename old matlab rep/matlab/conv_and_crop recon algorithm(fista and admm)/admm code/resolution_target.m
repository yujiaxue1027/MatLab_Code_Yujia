...
impulse_mat_file_name = './example_data/resolution_target_psf.mat';
...
image_file = './example_data/resolution_target_measure.png';
...
% Solver parameters
solverSettings.tau = 0.8;    %sparsity parameter for TV    default: 0.002
