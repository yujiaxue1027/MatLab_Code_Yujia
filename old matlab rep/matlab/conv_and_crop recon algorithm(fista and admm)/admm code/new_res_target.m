...
impulse_mat_file_name = './example_data/new_res_target_psf.mat';
...
image_file = './example_data/new_res_target.png';
...
% Solver parameters
solverSettings.tau = 1;    %sparsity parameter for TV    default: 0.002
